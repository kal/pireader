...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'reader_feed', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Feed.unread_count'
        db.add_column(u'reader_feed', 'unread_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Feed.keep_count'
        db.add_column(u'reader_feed', 'keep_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Category.owner'
        db.add_column(u'reader_category', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'reader_feed', 'owner_id')

        # Deleting field 'Feed.unread_count'
        db.delete_column(u'reader_feed', 'unread_count')

        # Deleting field 'Feed.keep_count'
        db.delete_column(u'reader_feed', 'keep_count')

        # Deleting field 'Category.owner'
        db.delete_column(u'reader_category', 'owner_id')
    ...
    models = {
        ...
        u'reader.feed': {
            ...
            'keep_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
